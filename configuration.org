...
** Font and theme
Currently using Terminus and Nord. Possibly the most unstable part of my config.
#+BEGIN_SRC emacs-lisp
  ;; Setting font size
  (add-to-list 'default-frame-alist '(font . "xos4 Terminus-20"))
